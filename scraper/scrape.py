...
for sid in stations:
    ...
    rows.append({
        ...
        "temp_maxima_timestamp": d["temp_maxima_timestamp"],
        "temp_minima_timestamp": d["temp_minima_timestamp"]
    })
...
cutoff = pd.Timestamp.now() - pd.Timedelta(days=30) # Changed from 7 to 30 days
